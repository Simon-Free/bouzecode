...
DEFAULTS = {
    ...
    "followup_compaction_enabled":  True,
    "followup_keep_last_n_turns":   0,
    "followup_exempt_tools":        ["Edit", "Write", "TodoWrite"],
    "max_agent_depth":  3,
    "max_concurrent_agents": 3,
    "gitlab_url":            "",     # base URL of your GitLab instance (if used)
