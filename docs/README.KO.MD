...
<div align=center>
<center style="color:#000000;text-decoration:underline">텔레그램 브리지: 휴대폰에서 Bouzecode 제어</center>
 </div>
...
Bouzecode는 Claude Code를 Python으로 다시 구현한 **가볍고** **사용하기 쉬운** 도구로, Claude, GPT, Gemini, Kimi, Qwen, Zhipu, DeepSeek, MiniMax, 그리고 Ollama 또는 OpenAI 호환 엔드포인트를 통한 로컬 오픈소스 모델 등 **사실상 모든 모델** 을 지원합니다.
...
| 항목 | OpenClaw (TypeScript) | Bouzecode (Python) |
|-----------|----------------------|---------------------|
