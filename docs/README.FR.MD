...
<div align=center>
<center style="color:#000000;text-decoration:underline">Passerelle Telegram : contrôlez Bouzecode depuis votre téléphone</center>
 </div>
...
Bouzecode : une réimplémentation Python de Claude Code, **légère** et **facile à utiliser**, avec **prise en charge de pratiquement tous les modèles**, notamment Claude, GPT, Gemini, Kimi, Qwen, Zhipu, DeepSeek, MiniMax, ainsi que des modèles open source locaux via Ollama ou tout endpoint compatible OpenAI.
...
### Qui devrait utiliser Bouzecode
