...
- `tool_call_alias` (string, optional): alias for this call (e.g. "w1"). Referenced by others via `depends_on`.
- `depends_on` (array of strings, optional): aliases/IDs that must complete before this tool runs. Use to chain tools in one turn.
