# [desc] Defines plugin system data types: manifest parsing, plugin entries, scopes, and identifier parsing. [/desc]
...
class PluginScope(str, Enum):
    USER     = "user"      # ~/.bouzecode/plugins/
    PROJECT  = "project"   # .bouzecode/plugins/ (cwd)
    EXTERNAL = "external"  # dirs from BOUZECODE_PLUGIN_PATH env var
