# [desc] Package init exposing plugin system types, store, loader, and recommendation APIs. [/desc]
"""Plugin system for bouzecode."""
...
from .loader import (
    ...
    check_missing_deps, ensure_plugin_dependencies,
)
...
__all__ = [
    ...
    "install_plugin", "uninstall_plugin",
    "enable_plugin", "disable_plugin", "disable_all_plugins",
    "update_plugin", "list_plugins", "get_plugin", "PLUGIN_PATH_ENV",
    "load_all_plugins", "load_plugin_tools", "load_plugin_skills",
    "load_plugin_mcp_configs", "register_plugin_tools",
    "check_missing_deps", "ensure_plugin_dependencies",
