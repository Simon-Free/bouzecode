# [desc] Thread-safe in-memory task store with JSON file persistence and CRUD operations. [/desc]
"""Thread-safe task store: in-memory dict persisted to .bouzecode/tasks.json."""
...
# Tasks are keyed by ID, stored per session in <cwd>/.bouzecode/tasks.json
...
def _tasks_file() -> Path:
    return Path.cwd() / ".bouzecode" / "tasks.json"
