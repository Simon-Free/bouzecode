#!/usr/bin/env python3
# [desc] Demo script showcasing multi-turn agent capabilities with tool use, streaming output, and auto-approval. [/desc]
"""
Demo script for bouzecode.
...
def demo():
    ...
    _run_demo(state2, config, system_prompt,
              "List all Python files in the current directory and show me the first 5 lines of bouzecode.py")
