# [desc] Registers MemorySave, MemoryDelete, MemorySearch, and MemoryList tools with the central registry. [/desc]
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "scope": {
                    ...
                    "enum": ["user", "project"],
                    "description": (
                        "'user' (default) = ~/.bouzecode/memory/ shared across projects; "
                        "'project' = .bouzecode/memory/ local to this project"
                    ),
                },
                "confidence": {
                    "type": "number",
