# [desc] Package init exposing persistent file-based memory storage, search, scanning, and context APIs. [/desc]
"""Memory package for bouzecode.

Provides persistent, file-based memory across conversations.

Storage layout:
  user scope    : ~/.bouzecode/memory/<slug>.md   (shared across projects)
  project scope : .bouzecode/memory/<slug>.md     (local to cwd)
