# [desc] Package init exposing MCP client, config, and tool registration APIs with transport documentation. [/desc]
"""mcp package — Model Context Protocol client for bouzecode.

Usage
-----
MCP servers are configured in one of two JSON files:

  ~/.bouzecode/mcp.json        (user-level, all projects)
