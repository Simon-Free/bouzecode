#!/usr/bin/env python3
# [desc] Generates an animated GIF demo showcasing the /brainstorm command workflow in bouzecode. [/desc]
"""
Generate animated GIF demo of bouzecode /brainstorm command using PIL.
