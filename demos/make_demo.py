#!/usr/bin/env python3
# [desc] Generates an animated GIF demoing bouzecode's terminal UI using PIL with Catppuccin theming. [/desc]
"""
Generate animated GIF demo of bouzecode using PIL.
...
def build_scenes():
    ...
    response_lines = [
        ...
        " 553  bouzecode.py — REPL entry point, slash commands, rich rendering",
        "────────────────────────────────────────────────────",
        "1261  total",
        "",
        "The largest file is `bouzecode.py` containing the interactive REPL,",
    ...
    msg2 = "Write a hello_world.py that prints 'Hello from Bouzecode!'"
...
def render_screenshot(output_path="screenshot.png"):
    ...
    lines = (
        ...
        [
            ...
            text_line(" 553  bouzecode.py — REPL + slash commands", 2),
            text_line("────────────────────────────────", 2),
            text_line("1261  total", 2),
            None,
            text_line("The main entry point `bouzecode.py` contains the REPL,", 2),
