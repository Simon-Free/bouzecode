#!/usr/bin/env python3
# [desc] Generates an animated GIF demo showcasing bouzecode's SSJ Developer Mode terminal UI. [/desc]
"""
Generate animated GIF demo of bouzecode SSJ Developer Mode.
...
def build_scenes():
    ...
    add(base_menu + [ssj_prompt("1")] + [
        None,
        [seg("  ── Brainstorm: ", SUBTEXT), seg("bouzecode SSJ features", CYAN), seg(" ──", SUBTEXT)],
        None,
