# [desc] FFmpeg-based video assembly: zoompan clips, concatenation, audio mixing, and subtitle burning. [/desc]
"""
...
_FONT_CACHE = os.path.join(os.path.expanduser("~"), ".bouzecode", "fonts")
...
def _get_subtitle_font() -> tuple[str | None, str | None]:
    ...
    On first call downloads NotoSansSC and caches to ~/.bouzecode/fonts/.
    """
