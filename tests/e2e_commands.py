# [desc] End-to-end tests for /init, /export, /copy, and /status CLI commands with temp directory isolation. [/desc]
...
def _run_tests(tmpdir):
    ...
    from bouzecode import cmd_init, cmd_export, cmd_copy, cmd_status, info, err
