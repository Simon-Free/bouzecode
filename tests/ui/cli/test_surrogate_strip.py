# [desc] Tests strip_unpaired_surrogates handles Windows clipboard UTF-16 surrogate corruption safely [/desc]
...
"""
from bouzecode.ui.cli import strip_unpaired_surrogates
