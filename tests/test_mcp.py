# [desc] Unit tests for MCP package types, config loading, client transport, and manager lifecycle. [/desc]
...
def reset_manager(monkeypatch):
    ...
    import mcp.manager as _manager_mod
    monkeypatch.setattr(_manager_mod, "_manager", None)
