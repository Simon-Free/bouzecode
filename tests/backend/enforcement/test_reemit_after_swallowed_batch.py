# [desc] Sans recovery ni bounce (Fallback B supprimé), un tour sans tool calls clôt la session proprement. [/desc]
...
def test_tour_thinking_seul_sans_recovery_clot_sans_bounce():
    """Un tour de pur raisonnement, recovery desactivee, clot la session sans rebond in-wire ni re-emission."""
    mock = MockLLM([
...
def test_message_enforcement_veridique_selon_calls_enregistres():
    """Le message d'enforcement dit la verite : aucun call enregistre, ou des calls deja enregistres."""
