"""Tests for the fresh-token reminder injection (A/B validated 2026-06-11).
...
- BOUZECODE_FRESH_REMINDER flag respects "0" = off
"""
...
class TestWireOnlyMutation:
    ...
    def test_original_messages_not_mutated(self):
        ...
        assert _FRESH_REMINDER in wire[2]["content"]
