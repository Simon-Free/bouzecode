# [desc] Unit tests for token estimation, context limits, tool result snipping, and split point logic.
# <tool_use name="FinalAnswer" id="x1"><param name="answer">Unit tests for token estimation, context limits, tool result snipping, and split point logic.</param></tool_use> [/desc]
"""Tests for compaction.py — token estimation, context limits, snipping, split point."""
from __future__ import annotations

from bouzecode.backend.agent.compaction import estimate_tokens, get_context_limit, snip_old_tool_results, find_split_point
