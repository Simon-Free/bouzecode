# [desc] Tests that system prompt lives in system_prompts/ dir and is correctly loaded by _embedded_data.py [/desc]
...
# test_regen_embedded_data_succeeds removed: there is no separate regen script
# anymore — _embedded_data.py loads prompts directly from system_prompts/ at import.
