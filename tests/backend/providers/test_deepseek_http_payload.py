# [desc] Diagnostic test capturing the HTTP payload sent to OpenRouter to verify Methodology/Snippet tools are present. [/desc]
...
def capture_session(monkeypatch):
    ...
    # Ignore any ambient proxy configuration
