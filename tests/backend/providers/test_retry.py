# [desc] <tool_use name="FinalAnswer" id="f1"><param name="answer">Tests retry logic for Anthropic API stream creation with rate limiting, budgets, and error handling.</param></tool_use> [/desc]
