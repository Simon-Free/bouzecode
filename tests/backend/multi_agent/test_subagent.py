...
from bouzecode.backend.multi_agent.subagent import SubAgentManager, SubAgentTask, _extract_final_text
...
def manager(monkeypatch):
    ...
    monkeypatch.setattr("bouzecode.backend.multi_agent.task._agent_run", mock)
