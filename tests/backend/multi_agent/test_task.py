# [desc] Unit tests for task CRUD operations, task types, persistence, and concurrency safety. [/desc]
...
from bouzecode.backend.tools.task.types import Task, TaskStatus
from bouzecode.backend.tools.task import (
...
class TestTaskToolFunctions:
    ...
    def test_task_create_tool(self):
        from bouzecode.backend.tools.task.tools import _task_create
    ...
    def test_task_update_tool_status(self):
        from bouzecode.backend.tools.task.tools import _task_create, _task_update
    ...
    def test_task_update_not_found(self):
        from bouzecode.backend.tools.task.tools import _task_update
        result = _task_update("999", status="completed")
        assert "not found" in result.lower()

    def test_task_get_tool(self):
        from bouzecode.backend.tools.task.tools import _task_create, _task_get
    ...
    def test_task_get_not_found(self):
        from bouzecode.backend.tools.task.tools import _task_get
        result = _task_get("999")
        assert "not found" in result.lower()

    def test_task_list_tool_empty(self):
        from bouzecode.backend.tools.task.tools import _task_list
        result = _task_list()
        assert "No tasks" in result

    def test_task_list_tool_multiple(self):
        from bouzecode.backend.tools.task.tools import _task_create, _task_list
    ...
    def test_task_list_hides_resolved_blockers(self):
        from bouzecode.backend.tools.task.tools import _task_create, _task_update, _task_list
    ...
    def test_tool_schemas_registered(self):
        ...
        import bouzecode.backend.tools.registration  # noqa: F401 — triggers side-effect registrations
    ...
    def test_tool_schemas_in_tool_schemas_list(self):
        ...
        from bouzecode.backend.tools import TOOL_SCHEMAS
