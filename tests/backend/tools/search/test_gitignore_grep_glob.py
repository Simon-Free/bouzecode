# [desc] <thinking>
# The user wants a single-line description of the test file.
# </thinking>
# 
# Tests for ignore_gitignore and include_patterns options in Grep/Glob shell search tools [/desc]
...
def test_glob_ignore_gitignore_true_does_not_add_no_ignore():
    ...
    with patch("bouzecode.backend.tools.ops.grep_glob._has_rg", return_value=True):
