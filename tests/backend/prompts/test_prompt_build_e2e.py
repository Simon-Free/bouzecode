# [desc] Conversation feature test: the real system prompt builds cleanly and reaches the model intact. [/desc]
...
def test_real_system_prompt_builds_and_reaches_the_model():
    ...
    # batch is bookkeeping and earns a continue-nudge instead (b83ade94).
    mock = MockLLM(["Hi!"])
